    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-8">
      ...
      <div className="space-y-6 border-b border-zinc-800 pb-8">
        <div className="flex items-start gap-12">
          {/* Profile Icon */}
          <div className="w-32 h-32 rounded-full bg-zinc-800 border-2 border-zinc-600 flex items-center justify-center text-6xl font-medium text-zinc-200 flex-shrink-0">
          ...
          <div className="flex-1">
            ...
            <div className="flex gap-12 text-sm">
              <div>
                <p className="text-zinc-400 text-sm mb-1">Videos</p>
              ...
              <div>
                <p className="text-zinc-400 text-sm mb-1">Following</p>
                <p className="text-white font-semibold text-2xl">
